...
const Notifications = () => {
  ...
  return (
    <>
      <SEO
        title="Notifications | SyncMove"
        description="Stay updated with the latest notifications from SyncMove, including partner requests, workout updates, and activity reminders to enhance your fitness journey."
        keywords="SyncMove notifications, fitness updates, workout notifications, partner requests, activity reminders"
      />
