...
// Left 1/3
// - Previous conversations cards (includes profile image, name, last message, and time)
// Horizontal divider
// Right 2/3
// - Messaging section
// - On the bottom, there is an input field for typing messages with the appropriate icon
// - in the middle is a h1 with text "Start Chatting Now!"
// If a user is clicked, previous conversations will be loaded with the newest message at the bottom
// The messaging Logic will be implemented in the future
